...
export class Multiselect {
  ...
  eventListener_(e) {
    ...
    } else if (!this.isUpdatingBlocks_ && e.type === Blockly.Events.CHANGE &&
        e.element === 'field' && this.blockSelection_.has(e.blockId)) {
      this.isUpdatingBlocks_ = true;
